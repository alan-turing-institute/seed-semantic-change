...
os.system("{tt_folder}/train-tree-tagger {curr_folder}/TreeTaggerData/lexicon.txt {curr_folder}/TreeTaggerData/openclass.txt {curr_folder}/TreeTaggerData/training_set.txt {curr_folder}/TreeTaggerData/ancient_greek.dat".format(tt_folder=treetagger, curr_folder=os.path.dirname(os.path.realpath(__file__))))